...
export const homeSlide = [
    {
        ...
        description: 'There are many variations of passages orem psum available but the majority have suffered alteration readable content looking page in some form by injected humour.',
    },
...
export const featureItem = [
    {
        ...
        description: 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis excepturi words.',
    },
...
export const testimonialItem = [
    {
        img: testimonialImg1,
        name: 'Niesha Phips',
        description: 'There are many variations passage available the majority have suffered of the alteration in some form by injected humour or randomised words which look even slightly believable.',
        stars: 4.5,
    },
